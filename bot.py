...
def start(message):
    ...
    bot.send_message(
        ...
        "Нажми кнопку ниже или используй команду /honey в группе.",
        reply_markup=markup
    )
...
def inline_help(query):
    ...
    result = telebot.types.InlineQueryResultArticle(
        id="openbot",
        title="🍯 HoneyRealmBot",
        description="Открыть бота и узнать своего персонажа",
        input_message_content=telebot.types.InputTextMessageContent(
            message_text=(
                "🍯 HoneyRealmBot\n\n"
                "Чтобы узнать своего персонажа:\n\n"
                "• В личном чате нажмите кнопку «🍯 Узнать, кто я»\n"
